...
import { html_content, react_content } from "../utils/constants";

const Skill = () => {
  return (
    <div>
      <h1 className="text-3xl px-8 font-bold text-center">Skills</h1>
      ...
      <div className="flex flex-wrap justify-around w-3/4 mx-auto">
        <div className="px-8 py-2">
          <SkillCard name="HTML" img="/html1.png" content={html_content}/>
        </div>
        <div className="px-8 py-2">
          <SkillCard name="React.js" img="/react3.png" content={react_content}/>
        </div>
        <div className="px-8 py-2">
